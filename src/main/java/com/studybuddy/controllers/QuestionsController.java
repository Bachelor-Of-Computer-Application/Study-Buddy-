...
public class QuestionsController {
    ...
    private void refreshAnswers(Question q) {
        ...
        for (Answer ans : q.getAnswers()) {
            ...
            String currentUserName = SessionManager.getInstance().getCurrentUser() != null ? SessionManager.getInstance().getCurrentUser().getName() : "Guest Student";
    ...
    public void handleSubmitAnswer() {
        ...
        if (text.isEmpty()) {
            ...
            alert.setContentText("Answer cannot be empty.");
            alert.showAndWait();
            return;
        }
        ...
        alert.setHeaderText(null);
        alert.setContentText("Your answer has been posted successfully.");
        alert.showAndWait();
    }
    private String getCurrentUserName() {
        if (SessionManager.getInstance().getCurrentUser() != null) {
            return SessionManager.getInstance().getCurrentUser().getName();
        }
