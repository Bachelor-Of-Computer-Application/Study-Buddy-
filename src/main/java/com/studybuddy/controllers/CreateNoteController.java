    ...
    public void saveNote() {
        ...
        try {
            ...
            if (App.getCurrentUser() != null) {
                note.setUserId(String.valueOf(App.getCurrentUser().getId()));
            } else {
                showAlert(Alert.AlertType.ERROR, "Database Error", "No logged-in user. Database save cancelled.");
                return;
            }
            ...
            showAlert(Alert.AlertType.ERROR, "Database Error", "Failed to save note: " + e.getMessage());
        }
    }
